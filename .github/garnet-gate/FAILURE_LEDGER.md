...
| F35 | 2026-09-22 | A fork Audit job failing on npm advisories published against an unchanged lockfile read as a Garnet pin regression | fork PR 66 | L8 records Audit as an upstream-lockfile leg, not a Garnet one; compare against main before attributing |
